...
const arrayToHTML = content =>
  ...
  >
    <div
      class="image"
      style="
        background: url('${ASSETS_DIR + item.path}'); background-size: contain; background-position: center;
        background-repeat: no-repeat; width: 6rem; height: 6rem; margin-bottom: 1rem;
